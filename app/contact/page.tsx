...
function GitHubIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 98 96" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div className="page-wrapper">
      ...
      <div className={styles.elsewhere}>
        ...
        <div className={styles.contactGrid}>
          <a href="mailto:dillon@datawithdillon.com" className={styles.contactWidget}>
            <span className={styles.contactIcon}>
              <EmailIcon />
            </span>
            <span className={styles.contactLabel}>Email</span>
            <span className={styles.contactValue}>dillon@datawithdillon.com</span>
          </a>
          <a
          ...
          >
            ...
            <span className={styles.contactValue}>/in/dillonshearer</span>
          </a>
          <a
          ...
          >
            ...
            <span className={styles.contactValue}>/dillon-shearer</span>
          </a>
        </div>
      </div>
    </div>
