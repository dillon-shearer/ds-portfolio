...
export default function BodyDiagram({
  ...
  return (
    ...
    >
      ...
      {/* Hover tooltip */}
      {hoveredPart && (
        <div className={styles.tooltip} style={{ left: mousePos.x + 14, top: mousePos.y - 10 }}>
    ...
    <group position={[0, 0, 0]} scale={0.98}>
      ...
      <group position={[0, 1.78, 0]}>
        ...
        <group position={[0, -0.02, 0.26]}>
          <RoundedBox args={[0.16, 0.1, 0.02]} radius={0.05} position={[-0.12, 0, 0]}>
            <meshStandardMaterial
              color="#1B1814"
              roughness={0.15}
              metalness={0.1}
          ...
          <RoundedBox args={[0.02, 0.02, 0.08]} radius={0.01} position={[-0.2, 0, -0.01]}>
            <meshStandardMaterial color="#1B1814" />
          </RoundedBox>
          <RoundedBox args={[0.02, 0.02, 0.08]} radius={0.01} position={[0.2, 0, -0.01]}>
            <meshStandardMaterial color="#1B1814" />
      ...
      <group position={[0, 1.05, 0]}>
        ...
        <group position={[-0.25, 0.22, Z_TORSO]} {...h('chest')}>
          <RoundedBox args={[0.47, 0.3, 0.3]} radius={0.12} smoothness={6} castShadow receiveShadow>
            {badge('chest')}
          </RoundedBox>
        </group>
        <group position={[0.25, 0.22, Z_TORSO]} {...h('chest')}>
      ...
      {/* Shoulder joints */}
      <group position={[-0.7, 1.28, 0]}>
        <RoundedBox args={[0.3, 0.24, 0.4]} radius={0.1} smoothness={7} castShadow receiveShadow>
          {base}
        </RoundedBox>
      </group>
      <group position={[0.7, 1.28, 0]}>
      ...
      <group position={[-0.98, 1.0, 0]}>
        <RoundedBox args={[0.36, 0.82, 0.36]} radius={0.12} smoothness={6} castShadow receiveShadow>
          {base}
        </RoundedBox>
        <group position={[-0.185, 0.2, 0]} {...h('shoulders')}>
          <mesh scale={[1, 1, 0.72]} castShadow receiveShadow>
            <capsuleGeometry args={[0.125, 0.125, 25, 22]} />
            {badge('shoulders')}
          </mesh>
        </group>
        <group position={[0, 0.0, 0.16]} {...h('biceps')}>
          <RoundedBox
            args={[0.26, 0.46, 0.26]}
            radius={0.12}
            smoothness={6}
      ...
      <group position={[-0.98, 0.42, 0]}>
        <RoundedBox args={[0.32, 0.72, 0.32]} radius={0.12} smoothness={6} castShadow receiveShadow>
          {base}
        </RoundedBox>
      </group>
      {/* Right lower arm */}
      ...
      <group position={[-0.98, -0.02, 0]}>
        <RoundedBox args={[0.34, 0.22, 0.34]} radius={0.1} castShadow receiveShadow>
          {base}
        </RoundedBox>
      </group>
      {/* Right wrist */}
      ...
      <group position={[0, 0.52, 0]}>
        <RoundedBox args={[1.06, 0.3, 0.5]} radius={0.12} smoothness={7} castShadow receiveShadow>
          {base}
        </RoundedBox>
        <group position={[-0.55, 0.1, 0]} {...h('hips')}>
          <RoundedBox
            args={[0.26, 0.26, 0.4]}
            radius={0.12}
            smoothness={6}
      ...
      <group position={[-0.4, 0.02, 0]}>
        <RoundedBox args={[0.46, 1.12, 0.46]} radius={0.14} smoothness={7} castShadow receiveShadow>
          {base}
        </RoundedBox>
        ...
        <group position={[0, 0.0, -0.18]} {...h('hamstrings')}>
          <RoundedBox
            args={[0.3, 0.74, 0.28]}
            radius={0.14}
            smoothness={6}
      ...
      {/* Left lower leg */}
      <group position={[-0.4, -0.86, 0]}>
        <RoundedBox args={[0.38, 0.92, 0.38]} radius={0.14} smoothness={7} castShadow receiveShadow>
          {base}
        </RoundedBox>
  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 320" style={{ width: '62%' }}>
        ...
        <text x="100" y="300" textAnchor="middle" fontSize="10" fill="var(--color-ink-3)">
          WebGL unavailable
        </text>
      </svg>
    </div>
